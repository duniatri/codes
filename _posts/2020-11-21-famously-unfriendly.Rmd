...
But for Windows OS, it's not that easy! Beside you have to install `tinytext`, you also have to separately install [MikTex](https://miktex.org/ "MikTex website") separately, and it's 240.7 MB! Then, after you knit your document, for me, the R Markdown console showing a looooot of red text which means a looooot of errors...

![](pictures/tinytex%20error.JPG "tinytex error"){#screenshot #error #tinytex}
...
![](pictures/texworks.JPG "texworks interface"){#screenshot #texworks #tinytex #MikTex}
...
![](pictures/clear%20knit%20cache.JPG "clear knit cache"){#screenshot #knit #rmarkdown}
